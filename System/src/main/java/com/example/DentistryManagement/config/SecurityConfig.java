        ...
        HttpSecurity httpSecurity = http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers("/admin/**").hasAnyRole(ADMIN.name(), MANAGER.name(), CUSTOMER.name())
                                .requestMatchers(GET, "/admin/**").hasAnyAuthority(READ.name(), WRITE.name())
                                .requestMatchers("/staff/**").hasAnyRole(ADMIN.name(), MANAGER.name(), CUSTOMER.name())
                                .requestMatchers(GET, "/staff/**").hasAnyAuthority(READ.name(), WRITE.name())
                                .anyRequest()
                                .authenticated()
                )
