        ...
        HttpSecurity httpSecurity = http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers("/api/v1/boss/**").hasRole(DENTIST.name())
                                .requestMatchers(GET, "/api/v1/boss/**").hasAuthority(READ.name())
                                .requestMatchers(POST, "/api/v1/boss/**").hasAuthority(UPDATE.name())
                                .requestMatchers(POST, "/api/v1/boss/**").hasAuthority(DELETE.name())
                                .requestMatchers(POST, "/api/v1/boss/**").hasAuthority(WRITE.name())
                                .anyRequest()
                                .authenticated()
                )
