        ...
        HttpSecurity httpSecurity = http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers("/api/v1/boss/**").hasRole(BOSS.name())
                                .requestMatchers(GET, "/api/v1/boss/**").hasAuthority(READ.name())
                                .requestMatchers(PUT, "/api/v1/boss/**").hasAuthority(UPDATE.name())
                                .requestMatchers(PUT, "/api/v1/boss/**").hasAuthority(DELETE.name())
